		...
		<div class="pb-4">
			...
			>
				...
				<a
					class="text-blue-700 dark:text-gray-400 text-sm font-semibold space-x-1 inline "
					:href="
						'whatsapp://send?text=Hey! Check out this amazing podcast:\n \n' +
							podcast.title +
							'\n \n' +
							generateItunesURL(podcast.title, podcast.itunes_id)
					"
...
export default defineComponent({
	...
	methods: {
		...
		generateItunesURL(title, itunesID) {
			let base = "https://podcasts.apple.com/us/podcast/";
			let slug_title = this.string_to_slug(title);
			return base + slug_title + "/id" + itunesID;
		},
